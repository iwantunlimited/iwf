                        ...
                        <Grid item xs={2}>
                            {
                                data.filters.map((ele, index) =>{
                                    if(index > 0){
                                        return <TextField required type="text" placeholder="Keyword" value={ele.fieldName} name={"fieldName"}  onChange={handleChnage1}  />
                                    }else{
                                        return null
                                    }}
                                )
                        ...
                        <Grid item xs={3}>
                            {
                                data.filters.map((ele, index) =>{
                                    if(index > 0){
                                        return <TextField required type="text" placeholder="Value" name={"value"} value={ele.value}  onChange={handleChnage1}  />
                                    }else{
                                        return null
                                    }}
                                )
                    ...
                    <div style={{width:'100%',height:'440px'}}>
                        <DataGrid 
                         components={{ Toolbar: GridToolbar }} 
                            ...
                            columns={Object.keys(testData.payload[0]).map((ele) => ({id:Math.random(),width:150,field:ele, headerName:ele.toUpperCase(), hide:false}))}
                        />
                    </div>
                }
            {/* {
